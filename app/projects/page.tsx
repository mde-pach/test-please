              ...
              {!searchQuery && (
                <div className="mt-4 flex items-center justify-center space-x-3">
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-sm font-medium rounded-lg transition-colors"
                  >
